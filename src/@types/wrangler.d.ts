/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/@types/wrangler.d.ts` (hash: e6260330d4d4c2902c8c5a502beaecb4)
// Runtime types generated with workerd@1.20260828.1 2026-08-20 
interface __BaseEnv_Env {
	LOG_SETTINGS: KVNamespace;
	DEFAULT_LOG_LEVEL: "log";
	MAX_FIELDS: "8";
	LOG_INTERNAL_ACTIVITY: "false";
	WEBHOOK: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_LOG_LEVEL" | "MAX_FIELDS" | "LOG_INTERNAL_ACTIVITY" | "WEBHOOK">> {}
}
